document.addEventListener('DOMContentLoaded', function() {
  ...
  function initPieChartReadiness() {
    ...
    function generateDonutSVG(data, total, centerText) {
      ...
      // Hollow Center & Center Text to make it a Donut Chart - Adjusted Radius for visual clarity
      svg += `<circle cx="50" cy="50" r="28" class="sc-donut-center" />`;
      svg += `<text x="50" y="46" class="sc-donut-text-perc" text-anchor="middle" dominant-baseline="central" font-family="sans-serif">${centerText}%</text>`;
      svg += `<text x="50" y="59" class="sc-donut-text-label" text-anchor="middle" dominant-baseline="central" font-family="sans-serif">Complete</text>`;
